...
struct Variables_t
{
	...
	C_ADD_VARIABLE(bool, bEspMainSkeleton, false);
	...
	C_ADD_VARIABLE(bool, bMiscDisableBlur, false);
	C_ADD_VARIABLE(bool, bMiscPredictNade, false);
	C_ADD_VARIABLE(bool, bMiscFakePrime, false);
	C_ADD_VARIABLE(bool, bMiscInverseGravity, false);
	C_ADD_VARIABLE(int, iMiscRagdollGravity, 600);
	C_ADD_VARIABLE(bool, bMiscRightHandKNF, false);
	#pragma endregion
